...
export class TimelineComponent {
  ...
  openConventionPopup() {
    ...
    dialogRef.afterClosed().subscribe(() => {
      ...
      // Ouvrir la fenêtre modale du journal de stage
  ...
  openJournalStagePopup() {
    // Vérifier si les étapes de la demande de stage et de la convention sont complétées
    if (this.demandeStageCompleted && this.conventionCompleted) {
      ...
      console.log('Impossible d\'ouvrir l\'étape du journal de stage car les étapes de la demande de stage et de la convention ne sont pas complétées.');
    }
  }
